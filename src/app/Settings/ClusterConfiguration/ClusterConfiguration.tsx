...
const ClusterConfig: React.FunctionComponent = () => {
  ...
  const portsValid =
    ...
    parsedPorts.every((p) => Number.isInteger(p) && p >= MIN_PORT && p <= MAX_PORT);
  const hostValid = form ? form.host.trim() !== "" : true;
  const controllerPortValid = form
    ? form.controllerPort >= MIN_PORT && form.controllerPort <= MAX_PORT
    : true;
  ...
  return (
    <AppPage title="Clustering Configuration" description={description} actions={actions}>
      ...
      >
        All connected sessions and administration connections (including this one) are disconnected
        ...
        <Bullseye>
          <div style={{ textAlign: "center" }}>
            ...
            <Content component="p" style={{ marginBlockStart: "var(--pf-t--global--spacer--md)" }}>
              Clustering configuration applied. Waiting for the VPN server to restart and come back
              online...
            </Content>
          </div>
        </Bullseye>
            ...
            <>
                  ...
                  <FormHelperText>
                    <HelperText>
                      <HelperTextItem variant="error">
                        The controller host name cannot be empty.
                      </HelperTextItem>
                    </HelperText>
                  </FormHelperText>
                )}
              ...
              <FormGroup label="Administration password" fieldId="cluster-password">
                ...
                <FormHelperText>
                  <HelperText>
                    <HelperTextItem>
                      Must match an administrator password on the controller. Leave blank to keep
                      the current one.
                    </HelperTextItem>
                  </HelperText>
                </FormHelperText>
      ...
      >
        ...
        <ModalBody>
          Applying this change <strong>restarts the VPN server</strong>. All connected sessions and
          management connections (including this one) are disconnected, and you will need to
          reconnect. Continue?
        </ModalBody>
        <ModalFooter>
          <Button
