...
const Dashboard: React.FunctionComponent = () => {
  ...
  const showDynamicDns =
    !loading && !hideAdminOnly && !hideNonBridge && !hiddenLabels.has("Dynamic DNS");
  const showVpnAzure =
    !loading && !hideAdminOnly && !hideNonBridge && !hiddenLabels.has("VPN Azure");
            ...
            <CardBody>
              ...
              >
                <DescriptionListGroup>
                  ...
                  <DescriptionListDescription>
                    {str("ServerProductName_str")}
                  </DescriptionListDescription>
                </DescriptionListGroup>
                <DescriptionListGroup>
                  <DescriptionListTerm>Version</DescriptionListTerm>
                  <DescriptionListDescription>
                    {str("ServerVersionString_str")}
                  </DescriptionListDescription>
                </DescriptionListGroup>
                <DescriptionListGroup>
                  <DescriptionListTerm>Hostname</DescriptionListTerm>
                  <DescriptionListDescription>
                    {str("ServerHostName_str")}
                  </DescriptionListDescription>
                </DescriptionListGroup>
                {showDynamicDns && (
                  <DescriptionListGroup>
