    ...
    const reveal = () => {
      ...
      frame = window.requestAnimationFrame(() => {
        const tabList = document.querySelector<HTMLElement>(
          "#hub-detail-tabs > .pf-v6-c-tabs__list",
        );
        ...
        const centeredPosition =
          activeTabItem.offsetLeft - (tabList.clientWidth - activeTabItem.offsetWidth) / 2;
    ...
    <>
      ...
      <AppPage title={name} description="Virtual Hub management.">
        ...
        >
          ...
          <Tab
            ref={selectedTabRef("tables")}
            eventKey="tables"
            title={<TabTitleText>Tables</TabTitleText>}
          >
            <HubTables hub={name} />
          </Tab>
          <Tab
            ref={selectedTabRef("cascade")}
            eventKey="cascade"
            title={<TabTitleText>Cascade</TabTitleText>}
          >
            <Cascade hub={name} />
          </Tab>
          <Tab
          ...
          {!hideNonCluster && (
            <Tab
              ...
              eventKey="securenat"
              title={<TabTitleText>Secure NAT</TabTitleText>}
            >
              <SecureNAT hub={name} />
            </Tab>
          )}
