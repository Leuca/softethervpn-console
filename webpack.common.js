    ...
    plugins: [
      ...
      new CopyPlugin({
        patterns: [
          ...
          { from: './src/favicon-light.svg', to: 'images' },
          { from: './src/favicon-dark.svg', to: 'images' },
        ],
      }),
    ],
    resolve: {
      ...
      // vpnrpc only requires these in its Node.js code path (browser mode uses fetch)
      fallback: { https: false, url: false },
    },
  };
};
